...
//    */
function appointmentOfAuditors($html, $pdf_name, $data, $output_type = "I")
{
    ...
    $tcpdf = new PDFSFA(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, TRUE, 'UTF-8', FALSE);
      ...
      $companyTitleStr = $data['app']['company_name'];
      $addressStr = $data['app']['addr_1'] ? '<span>' . $data['app']['addr_1'] . '</span><br>' : '';
      $address2Str = $data['app']['addr_2'] ? '<span>' . $data['app']['addr_2'] . '</span><br>' : '';
      $contactNoStr = $data['app']['phone'] ? '<span>TEL: ' . $data['app']['phone'] . '</span><br>' : '';
      $mailStr = $data['app']['email'] ? '<span>Email: ' . $data['app']['email'] . '</span><br>' : '';
     $tcpdf->setCustomHeaderText('
       <style>
         span {font-size: 11px;font-weight: normal;font-family: Arial, Helvetica, sans-serif;}
       </style>
